...
const navItems = [
  { name: "Home", href: "/" },
  { name: "The Artists", href: "#artists", hasDropdown: true, isScrollLink: true },
  { name: "Gallery", href: "#gallery", isScrollLink: true },
  { name: "Contact", href: "#contact", isScrollLink: true },
  { name: "Submit Art", href: "#submit" },
];
...
export default function Header() {
  ...
  const handleNavClick = (href: string, isScrollLink?: boolean) => {
