...
export default function ArtworkCardWhite({ artwork, onViewDetail, onClick, aspectRatio = 'square' }: ArtworkCardProps) {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-shadow">
        ...
        {/* Content */}
        <div className="p-4">
          <h3 className="font-playfair text-lg font-semibold text-black mb-1 line-clamp-1 group-hover:text-purple-600 transition-colors">
            {artwork.title}
          </h3>
