      ...
      case "comment":
        return (
          <>
            ...
            {activity.comment && (
              <div className="text-sm text-gray-400 mt-1 italic">"{activity.comment}"</div>
            )}
          </>
        );
      case "purchase":
      ...
      <div className="container py-12">
          ...
          <div className="max-w-3xl">
            <div className="space-y-4">
              {mockActivities.map((activity) => (
                <div
                  key={activity.id}
                  className="bg-gray-900 rounded-xl p-6 border border-white/10 hover:border-white/20 transition-colors"
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="text-white mb-1">{getActivityText(activity)}</div>
        ...
        {activeTab === "favorites" && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-400">Start favoriting artworks to see them here</p>
          </div>
        )}
